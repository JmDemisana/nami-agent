...
function NamiAgentChat({ onRoute, compact, hideTitlebar, onReset }: NamiAgentProps & { onReset: () => void }) {
  ...
  const getSystemPrompt = () => {
    const parts = [
      ...
      "  [ROUTE:ONU]    — Jillbox / Onu card game",
      "  [ROUTE:TYPER]  — Typer Shork typing arcade game",
      "  [ROUTE:CURRENC]— CurrenC currency converter",
      "  [ROUTE:ART]    — Artwork Finder cover art puller",
      "  [ROUTE:LORE]   — Nanami Lorebook reference notes",
      "  [ROUTE:KHEN]   — KhenAcademy study guide helper",
      "  [ROUTE:ANILIST]— AniList anime tracker lists & stats",
      "",
